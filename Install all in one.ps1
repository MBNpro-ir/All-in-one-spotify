...
function Install-Extension-HistoryInSidebar {
    try {
        ...
        Invoke-WebRequest -Uri "https://codeload.github.com/Bergbok/Spicetify-Creations/zip/refs/heads/dist/history-in-sidebar" -OutFile "$extensionsDir\history-in-sidebar.zip" -ErrorAction Stop
        Show-Status "HistoryInSidebar extension downloaded."
    ...
    do {
        ...
        switch ($choice) {
            ...
            "3" {
                ...
                $extChoice = Read-Host "Select an option"
                switch ($extChoice) {
...
function Show-Menu {
    do {
        ...
        Write-Host "4. Spicetify Apply Configs"
        Write-Host "5. Cleanup Downloads"
        Write-Host "6. Uninstall Menu"
        Write-Host "7. Exit"
        Write-Host "========================="
